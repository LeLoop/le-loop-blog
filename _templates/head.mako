...
%elif category:
<title>${category} :: ${bf.config.blog.name}</title>
%else:
...
<link rel="icon" href="${bf.util.site_path_helper(bf.config.blog.path,'/favicon.ico')}" />
<link rel="apple-touch-icon" href="${bf.util.site_path_helper(bf.config.blog.path,'/img/mac-goatse.png')}" />
